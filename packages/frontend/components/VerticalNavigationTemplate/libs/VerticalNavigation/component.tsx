...
export const VerticalNavigation: React.FC = () => {
  ...
  return (
    ...
    >
      <button className="flex items-center justify-start w-full px-6 pt-6 text-gray-800 dark:text-white hover:text-black focus:outline-none focus:text-black space-x-3">
        <svg
          width="34"
          height="34"
          viewBox="0 0 34 34"
      ...
      <div className="flex flex-col items-start justify-start w-full px-4 pb-5 mt-6 space-y-3">
        <Link href="/">
      ...
      <div className="flex flex-col items-start justify-start w-full px-4 pb-5 mt-6 dark:text-white space-y-3">
        <button
          className="flex items-center justify-start w-full py-3 pl-4 text-gray-600 rounded focus:outline-none dark:text-white hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700"
        ...
        <button className="flex items-center justify-start w-full py-3 pl-4 text-gray-600 rounded focus:outline-none dark:text-white space-x-6 hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700">
          ...
          <p className="text-base leading-4">Reaction game</p>
        </button>
      </div>
